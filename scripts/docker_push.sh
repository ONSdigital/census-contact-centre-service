...
docker tag eu.gcr.io/census-int-ci/census-contact-centre-service:$VERSIONTAG eu.gcr.io/census-int-ci/census-contact-centre-service:$PURPOSETAG
docker push eu.gcr.io/census-int-ci/census-contact-centre-service:$PURPOSETAG
