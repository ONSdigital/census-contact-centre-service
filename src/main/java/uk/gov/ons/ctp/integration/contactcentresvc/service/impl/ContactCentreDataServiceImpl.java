...
import uk.gov.ons.ctp.integration.contactcentresvc.cloud.GCSDataStore;
...
import uk.gov.ons.ctp.integration.contactcentresvc.service.ContactCentreDataService;
 ...
 */
@Service
public class ContactCentreDataServiceImpl implements ContactCentreDataService {
  private static final Logger log = LoggerFactory.getLogger(ContactCentreDataServiceImpl.class);
