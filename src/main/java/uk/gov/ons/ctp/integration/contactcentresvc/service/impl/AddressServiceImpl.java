...
public class AddressServiceImpl implements AddressService {
  ...
  public PostcodeQueryResponseDTO postcodeQuery(PostcodeQueryRequestDTO postcodeQueryRequest) {
    ...
    PostcodeSearchDataDTO addressIndexResponse = addressIndexClient.getResource(path,
        PostcodeSearchDataDTO.class, null, queryParams, postcode);
    log.debug("PostcodeQuery. Address Index service " + "response status: "
