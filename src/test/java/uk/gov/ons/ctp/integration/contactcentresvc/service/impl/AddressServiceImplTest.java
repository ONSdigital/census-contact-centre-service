...
public class AddressServiceImplTest {
  ...
  private void verifyAddresses(AddressQueryResponseDTO results) {
    ...
    assertEquals("E", addresses.get(0).getCountryCode());
    ...
    assertEquals("E", addresses.get(1).getCountryCode());
    ...
    assertEquals("E", addresses.get(2).getCountryCode());
    ...
    assertEquals("E", addresses.get(3).getCountryCode());
