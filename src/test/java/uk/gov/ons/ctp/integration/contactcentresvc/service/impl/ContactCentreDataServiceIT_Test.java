...
import uk.gov.ons.ctp.integration.contactcentresvc.domain.model.Address;
...
public class ContactCentreDataServiceIT_Test {

  private ContactCentreDataService cloud;
  ...
  @Before
  public void setup() {
    cloud = new ContactCentreDataServiceImpl();
    caseId = "123456789";
