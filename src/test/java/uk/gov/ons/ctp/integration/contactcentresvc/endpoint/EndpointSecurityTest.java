...
public class EndpointSecurityTest {
    ...
    @Test
    public void whenUserWithWrongCredentialsRequestCaseThenUnauthorizedPage() 
      throws Exception {
    ...
    @Test
    public void whenUserWithCorrectCredentialsRequestCaseThenSuccess() 
      throws Exception {
